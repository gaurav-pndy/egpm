    ...
    <section className="flex flex-col items-center mb-12">
      ...
      <div className="relative w-full ">
        ...
        <img
          ...
          className="w-full object-cover h-[65vh] md:h-[35vh]"
        />
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center p-4 px-2 text-white text-center ">
          ...
          <p className="text-xl md:text-4xl mb-2">for</p>{" "}
      ...
      <div className="w-full  mt-3 max-w-5xl text-[rgb(0,37,65)] p-4 md:p-6 text-base md:text-[1.6rem] leading-7 md:leading-8 font-[500]">
        <h3 className=" font-bold mb-8 ">Our Goals</h3>
        <div className="space-y-6 ml-8  leading-relaxed">
          <p>
            <span className="font-bold underline text-3xl">G</span>uidance and
            coordination particularly in the field of education
          </p>
          <p>
            <span className="font-bold underline text-3xl">R</span>oad map for
            resolving individual issues in a coherent and coordinated manner
          </p>
          <p>
            <span className="font-bold underline text-3xl">A</span>
            ssistance in obtaining official support from respective authorities
          </p>
          <p>
            <span className="font-bold underline text-3xl">S</span>
            trengthen cultural exchange between nations to promote values
          </p>
          <p>
            <span className="font-bold underline text-3xl">P</span>romotion of
            holistic model to build an integrated peace movement
          </p>
        </div>
      </div>
    </section>
